...
// --- Sub-component: City Autocomplete ---
									...
									<motion.div
										...
										<div className="text-center relative py-6">
											...
											<p className="text-sm text-muted-foreground mt-2 max-w-sm mx-auto">
												Review your logistics protocol and select your preferred
												fleet unit below.
											</p>
										</div>

										{/* 1. ITINERARY TEXT BLOCK (Cleaned of IDs) */}
										...
										{/* 2. THE AZAD RIDE SELECTION (Where you put the new Cards) */}
											...
											<div className="pt-16 border-t border-border mt-16">
												<div className="flex items-center justify-between mb-10 pb-4 border-b border-border/50">
													...
													<div className="text-xs font-medium text-muted-foreground px-4 py-2 bg-muted/30 rounded-full flex items-center gap-2">
														...
														Based on distance, passengers, and terrain.
													</div>
												</div>

												{/* A list layout (not grid) works best for displaying images next to details */}
													...
													{suggestedVehicles.map((vehicle) => (
														<div
															...
															<div className="p-10 flex flex-col flex-1">
																...
																{/* Car Stats - Look and feel of professional car rental */}
																...
																<div className="mt-auto pt-8 border-t border-border flex flex-col md:flex-row md:items-center justify-between gap-6 md:gap-4">
																	<div className="p-4 bg-muted/40 rounded-2xl flex flex-col">
																		<span className="block text-[9px] font-black uppercase text-muted-foreground tracking-widest">
																			Est. Transport Cost for {tripDistance} km
																		</span>
																	...
																	<Button className="w-full md:w-auto bg-black text-white text-[11px] h-14 px-10 rounded-full font-black uppercase tracking-widest hover:bg-neutral-800 transition-all active:scale-95 shadow-xl shadow-neutral-300">
																		Book Now
																	</Button>
																</div>
															</div>
